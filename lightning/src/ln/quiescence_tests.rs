...
fn quiescence_updates_go_to_holding_cell(fail_htlc: bool) {
	...
	if fail_htlc {
		...
		let failed_payment = HTLCHandlingType::FailedPayment { payment_hash: payment_hash2 };
	...
	if fail_htlc {
		...
		let failed_payment = HTLCHandlingType::FailedPayment { payment_hash: payment_hash1 };
